#!/usr/bin/env python3
"""
Generate OAuth 2.0 refresh token for Google services (force consent).

Usage:
    python get_refresh_token_force.py "scope1 scope2 ..." [--port PORT]

Example:
    python get_refresh_token_force.py "https://mail.google.com/" --port 8080
"""
...
def main():
    ...
    try:
        ...
        print("   ⚠️  This will force re-consent to get a new refresh token")
        print()
